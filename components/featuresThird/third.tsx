...
export const Third = ({ mirrored = false }: { mirrored?: boolean }) => {
    return (
        <div
            className={cn(
                "w-full h-full min-h-[320px] mt-6 md:mt-8 p-1.5 pb-0 bg-neutral-100/70 dark:bg-neutral-900/40 overflow-hidden",
                mirrored
                    ? "rounded-tr-2xl md:rounded-tr-3xl border-t border-r border-neutral-200/80 dark:border-neutral-800 pl-0"
                    : "rounded-tl-2xl md:rounded-tl-3xl border-t border-l border-neutral-200/80 dark:border-neutral-800 pr-0"
            )}
        >
            <div
                className={cn(
                    "relative w-full h-full min-h-[310px] bg-white dark:bg-neutral-950 overflow-hidden shadow-xs [perspective:1000px]",
                    mirrored
                        ? "rounded-tr-xl md:rounded-tr-2xl border-t border-r border-neutral-200 dark:border-neutral-800"
                        : "rounded-tl-xl md:rounded-tl-2xl border-t border-l border-neutral-200 dark:border-neutral-800"
                )}
            >
                <motion.div
                ...
                >
                    ...
                    <div className={cn(
                        ...
                        >
                            <IconLoader2 className="size-4 animate-spin [animation-duration:3s] shrink-0" stroke={2.2} />
